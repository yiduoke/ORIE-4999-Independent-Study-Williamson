...
test_case_1 = mean([flip_coin_max_cut(Dict(1=>[2,4], 2=>[1,3], 3=>[2,4], 4=>[1,3]))[1] for i in 1:50])
test_case_2 = mean([flip_coin_max_cut(Dict(1=>[2,5], 2=>[1,3,5], 3=>[2,4], 4=>[3,5], 5=>[1,2,4]))[1] for i in 1:50])
test_case_3 = mean([flip_coin_max_cut(Dict(1=>[2,3], 2=>[1,4,5], 3=>[1,6,7]))[1] for i in 1:50])

println("test 1. mean randomized max cut: $(test_case_1) (should be >=2)")
println("test 2. mean randomized max cut: $(test_case_2) (should be >=2.5)")
