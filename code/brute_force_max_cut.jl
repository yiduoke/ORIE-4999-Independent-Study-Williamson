...
test_case_1 = brute_force_max_cut(Dict(1=>[2,4], 2=>[1,3], 3=>[2,4], 4=>[1,3]))
test_case_2 = brute_force_max_cut(Dict(1=>[2,5], 2=>[1,3,5], 3=>[2,4], 4=>[3,5], 5=>[1,2,4]))
test_case_3 = brute_force_max_cut(Dict(1=>[2,3], 2=>[1,4,5], 3=>[1,6,7]))
